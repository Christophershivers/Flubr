...
namespace Flubr.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public async Task<IActionResult> Account(string id)
        {
            ...
            //var connection = "Data Source=SQL8001.site4now.net;Initial Catalog=db_a99d10_goku223344001;User Id=db_a99d10_goku223344001_admin;Password=Gohon223344!";
            //var listener = new SqlDependencyEx(connection, "db_a99d10_goku223344001", "UserMessage");
        ...
        [HttpPost]
        public async Task<IActionResult> AddMessage(MessagesModel mm, UserMessagesModel um, string id, AccountViewModel AVM, MessageThreadModel mtm)
        {
            ...
            //adding the receipient to the message thread table
            mtm.MessageId = AVM.MM.MessageId;
            mtm.UserId = id;
            mtm.MessageThreadId = Guid.NewGuid().ToString();

            _FC.MessageThread.Add(mtm);
            _FC.SaveChanges();


            //adding signed in user to the message thread table
            mtm.MessageId = AVM.MM.MessageId;
            mtm.UserId = _UM.GetUserAsync(User).Result.Id;
            mtm.MessageThreadId = Guid.NewGuid().ToString();
            _FC.MessageThread.Add(mtm);
            _FC.SaveChanges();
            ...
            AVM.UM.MessageId = AVM.MM.MessageId;
