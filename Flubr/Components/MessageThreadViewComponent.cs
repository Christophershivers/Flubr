...
{
    public class MessageThreadViewComponent: ViewComponent
    {
        ...
        public MessageThreadViewComponent(ILogger<MessageThreadViewComponent> logger, FlubrContext FC, UserManager<ApplicationUser> UM, SignalHub Sig, MessagesRepository MP)
        {
            _logger = logger;
            _FC = FC;
            _UM = UM;
